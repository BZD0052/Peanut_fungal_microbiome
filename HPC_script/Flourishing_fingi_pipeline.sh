...
echo "On sample: $sample"
    ...
    python /scratch/aubbxd002/Peanut_Final/Fungal_final/replace_fastaheaders2.py mapping/${sample}_trimmed.fasta --output-dir mapping/
...
##################################
# taxonomy assignment - CONSTAX  #
##################################

echo "######################## CONSTAX ###########################"

module load anaconda/3-2021.11
export CONDA_PREFIX=/opt/asn/apps/anaconda_3-2021.11

mkdir taxonomy_assignments/

constax --mem 200000 --num_threads 8 \
--db ~/noel_shared/db_fungi/unite_v10_04042024_Euk/sh_general_release_dynamic_s_all_04.04.2024.fasta \
--input clustered/otus.fasta \
--trainfile ~/noel_shared/db_fungi/unite_v10_04042024_Euk/constax_training_files \
--tax taxonomy_assignments \
--output taxonomy_assignments \
--conf 0.8 \
--blast \
--constax_path /apps/x86-64/apps/anaconda_3-2021.11/opt/constax-2.0.18-0 \
--high_level_db ~/noel_shared/db_fungi/noel_lab_fungalsequences/combinedNoelFungi_050422_unite.fasta \
